...
<title>혼밥의 고수 이벤트</title>
 <script src="${pageContext.request.contextPath}/resources/js/jquery-3.6.1.min.js"></script>
  <link
    ...
    />
    <!--검색 버튼 아이콘-->
    <link href="${pageContext.request.contextPath}/resources/css/eventList.css" rel="stylesheet" />
    <!--css 연결-->
</head>
<body>
	<nav>
		<div id="topMenu">
			<div class="logo">
				      <a href="<%=request.getContextPath()%>"> <img src="../resources/img/사본 -혼밥의고수 로고 초안_대지 1 사본.png"
					width="200px" />
				</a>
			</div>
			<!--end: #topMenu-->
		...
		<div id="inner">
			<div class="boardSet">
				<div class="boardSearch">
					...
					<button type="submit" class="bSearchBtn">검색
					</button>
				</div>
				<!--end: .boardSearch-->
			...
			<div class="boardList">
				<ul>
					<li><a href="#">제목을 입력하세요</a>
						<div class="boardContent">
							<span>진행중</span>
							<p>작성자 &nbsp;&#124;&nbsp; 2023.01.16 &nbsp;&#124;&nbsp; 조회수 0
								&nbsp;&#124;&nbsp; 댓글수 0 &nbsp;&#124;&nbsp; 추천수 0</p>
						</div> <!--end: boardContent--></li>
					<li><a href="#">Stay foolish, Stay hungry</a>
						<div class="boardContent">
							<span>진행중</span>
							<p>작성자 &nbsp;&#124;&nbsp; 2023.01.16 &nbsp;&#124;&nbsp; 조회수 0
								&nbsp;&#124;&nbsp; 댓글수 0 &nbsp;&#124;&nbsp; 추천수 0</p>
						</div> <!--end: boardContent--></li>
					<li><a href="#"> 흐르는강물을거꾸로거슬러오르는연어들의도무지알수없는 그들만의 신비한 이유처럼
							그 언제 서부터인가 걸어 걸어 걸어오는 이길 앞으로 얼마나 더 많이 가야만 하는지 </a>
						<div class="boardContent">
							<span>NEW</span>
							<p>작성자 &nbsp;&#124;&nbsp; 2023.01.16 &nbsp;&#124;&nbsp; 조회수 0
								&nbsp;&#124;&nbsp; 댓글수 0 &nbsp;&#124;&nbsp; 추천수 0</p>
						</div> <!--end: boardContent--></li>
					<li><a href="#">안녕안녕안녕안녕안녕안녕안녕안녕안녕안녕안녕</a>
						<div class="boardContent">
							<p>작성자 &nbsp;&#124;&nbsp; 2023.01.16 &nbsp;&#124;&nbsp; 조회수
								20930 &nbsp;&#124;&nbsp; 댓글수 1000 &nbsp;&#124;&nbsp; 추천수 2000</p>
						</div> <!--end: boardContent--></li>
					<li><a href="#">coffeecoffeecoffeecoffeecoffeecoffeecoffee</a>
						<div class="boardContent">
							<p>작성자 &nbsp;&#124;&nbsp; 2023.01.16 &nbsp;&#124;&nbsp; 조회수 0
								&nbsp;&#124;&nbsp; 댓글수 0 &nbsp;&#124;&nbsp; 추천수 0</p>
						</div> <!--end: boardContent--></li>
					<li><a href="#">FONTFONTFONTFONTFONTFONTFONTFONTFONTFONTFONT</a>
						<div class="boardContent">
							<p>작성자 &nbsp;&#124;&nbsp; 2023.01.16 &nbsp;&#124;&nbsp; 조회수 0
								&nbsp;&#124;&nbsp; 댓글수 0 &nbsp;&#124;&nbsp; 추천수 0</p>
						</div> <!--end: boardContent--></li>
	...
	<footer>
		<div id="slogan">
			<img src="../resources/img/사본_-혼밥의고수_로고_초안_대지_1_사본-removebg-preview.png"
				width="200px" />
		...
		<div id="footerMenu">
			...
			<p class="companyInfo">
				혼밥의고수 &#124; 대표자: 고독한 미식가 &#124; 전주시 덕진구 백제대로 572 4층 이젠컴퓨터아트서비스학원 <br />
