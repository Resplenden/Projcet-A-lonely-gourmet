      ...
      <main>
        <div id="title">
          <select class="category" name="category">
			<option value='자유' <c:if test="${vo.category eq '자유' }">selected</c:if>>자유</option>
			<option value='후기' <c:if test="${vo.category eq '후기' }">selected</c:if>>후기</option>
		  </select>
          <input
            type="text"
            name="title"
